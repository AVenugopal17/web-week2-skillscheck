...
function iLove (Bryan, lovesskateboarding){
	nameparam = "Bryan";
	loveparam = " loves skateboarding";
	return (nameparam + loveparam);
}
...
var me = {
	...
	state: 'Arizona',
	age: 27,
	greeter:'Hello! My name is Aarti and I live in Arizona'
}
...
var myNumbersIndex = [];
myNumbersIndex.forEach(myNumbers (item, index));
...
var forTheLoveOfGeorge = forTheLoveOfGeorge.map ('George', 'George', 'George', 'George' , 'George');
...
var totallyAwesome = people.reduce(function(person){
	return awesomeLevel === true; 
});
