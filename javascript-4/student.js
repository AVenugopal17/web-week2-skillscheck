...
var me = {
    firstName: 'Aarti',
    superHeroName: 'Ambitious Aarti',
    homeTown: 'Hyderabad',
    superPowers: ['being invisible', 'hearing peoples thoughts', 'flying'],
    superPowerXP: Math.floor(math.random(7)*100) + 1,
...
var regularName = 'Aarti';
var superName = 'Ambitious Aarti',
...
function setColor(arr){
    array.splice[('purple', 'green', 'pink')]
    setColor.forEach(function(index, item, array){
...
function setPowers(arr){
    setPowers.forEach(function(index, item, array){
        console.log(item, index);
    })
    setPowers.call(createLi);
}
...
function redactInfo(obj){
    redactInfo.array.forEach(redacted => {
        });
}